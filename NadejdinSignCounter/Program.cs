namespace NadejdinSignCounter
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("С превышением до 100000 не хватает: " + (100000 - excess) + " подписей.");
            Console.WriteLine("Без превышения до 100000 не хватает: " + (100000 - notExcess) + " подписей.");
